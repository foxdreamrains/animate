      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit Produk</a>
          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <form action="{{ route('kategoriUpdate') }}" method="POST">
                          {{ csrf_field() }}
                          <input type="hidden" name="id" value="{{ $kategoriS->id_kategori }}">
                          <label class="bmd-label-floating">Nama Kategori</label>
                          <input type="text" name="nama_kategori" value="{{$kategoriS->nama_kategori ?? old('nama_kategori')}}" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label class="bmd-label-floating">Slug</label>
                          <input type="text" name="slug_kategori" value="{{$kategoriS->slug_kategori ?? old('slug_kategori')}}" class="form-control" required>
                      </div>
                      <div class="form-group">
                          <label class="bmd-label-floating">Warna Kategori</label>
                          <div class="pilihan-kategori" style="width:200px;">
                                <select name="card_kategori">
                                    <option class="{{$kategoriS->card_kategori}}" value="{{$kategoriS->card_kategori}}" name="card_kategori">Pilih Warna Baru</option>
                      ...
                      <div class="form-group">
                          ...
                          <textarea name="ket_kategori" class="form-control" required>{{$kategoriS->ket_kategori ?? old('ket_kategori') }}</textarea>
                      </div>
