            ...
            <div class="col-md-8">
              ...
              <div class="card-body">
                <form action="{{ route('produkTambah') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <?php $jmlh = $produk->id+1;
                     ?>
                    <input type="hidden" name="produk_id" value="{{ $jmlh }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="bmd-label-floating">Pilih kategori</label><br/>
                                <div class="pilihan-kategori" style="width:200px;">
                                <select name="kategori_id">
                                    @foreach($kategori as $kategoriS)
                                    <option value="{{ $kategoriS->id_kategori }}" name="kategori_id">{{ ucwords($kategoriS->nama_kategori) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-rupiah" name="harga" value="{{ old('harga') }}" class="form-control" required>
                                </div>
                              <div class="form-group">
                                <label class="bmd-label-floating">Deskripsi</label>
                                <textarea name="deskripsi" value="{{ old('deskripsi') }}" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
