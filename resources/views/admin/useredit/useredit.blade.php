    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
                <a href="{{ route('userEditTambahView') }}" class="waves-effect waves-light btn" style="background: #4a148c; color: white; font-size: 12px;">Tambah User</a>
              <div class="card">
                <div class="card-header card-header-primary active">
                  <h4 class="card-title">Setting All User</h4>
