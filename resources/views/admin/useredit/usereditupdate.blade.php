...
@section('content')
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit User</a>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
            <a href="{{ route('userEdit') }}" class="btn waves-effect waves-light" type="submit" style="background: purple; color: white;" name="action">Kembali</a>
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="card-body">
                <form action="{{ route('userEditUpdate') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="telepon" value="{{ $userS->telepon }}" class="form-control">
                            </div>
                            <div class="form-group">
